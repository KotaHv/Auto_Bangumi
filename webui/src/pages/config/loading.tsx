...
import { ConfigDownloadFields } from '@/components/config/download';
import { ConfigManageFields } from '@/components/config/manage';
import { ConfigNormalFields } from '@/components/config/normal';
import { ConfigNotificationFields } from '@/components/config/notification';
import { ConfigOpenAIFields } from '@/components/config/openai';
import { ConfigParserFields } from '@/components/config/parser';
import { ConfigProxyFields } from '@/components/config/proxy';
